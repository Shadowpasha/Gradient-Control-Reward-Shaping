    ...
    * v0: Initial versions release
    ...
    def __init__(self, render_mode: Optional[str] = None, g=10.0, enable_logging: bool = True):
        ...
        if self.enable_logging:
            self.writer = SummaryWriter("runs/upright_time_GCR_" + datetime.now().strftime("%m_%d_%Y_%H_%M_%S"))
        ...
        self.clock = None
        self.isopen = True
        self.gcr =  GCR(0.5,0.1,0.001,5.0,1.0,(-2.5,2.5),(-0.2,0.2))
        # self.gcr =  GCR(0.5,0.1,0.001,5.0,1.0,(-2.5,2.5),(-0.2,0.2)) #SAC
    ...
    def step(self, u):
        ...
        costs = self.gcr.update(0.0,abs(angle_normalize(th)),time_difference)
        # print(costs)
        self.prev_time = time.time_ns()
        # print(costs)
        # print(self.state[1],abs(angle_normalize(self.state[0])) )
        ...
        newth = th + newthdot * dt
            # if(self.upright == False):
                # self.upright_times.append([2,self.step_counter])
            # np.save("upright",np.array(self.upright_times))
